...
[7-movethatfile](./7-movethatfile) - Move the file betty from /tmp/ to /my_first_directory.
...
[school.mgc](./school.mgc) - Create a magic file school.mgc that can be used with the command file to detect School data files. School data files always contain the string SCHOOL at offset 
